...
#   rankdir = LR
#   node [shape=record]
#   2 [label="{  a2 | 4 } | { 0 | 4 } | { 0 | 4 } | { 0 | 0 }"]
#   3 [label="{  a3 | 9 } | { 0 | 9 } | { 4 | 13 } | { 4 | 0 }"]
#   4 [label="{  a4 | 1 } | { 0 | 1 } | { 2 | 3 } | { 2 | 0 }"]
#   5 [label="{  a5 | 4 } | { 4 | 8 } | { 4 | 8 } | { 0 | 0 }"]
#   6 [label="{  a6 | 5 } | { 1 | 6 } | { 3 | 8 } | { 2 | 0 }"]
#   10 [label="{ a10 | 3 } | { 9 | 12 } | { 13 | 16 } | { 4 | 4 }"]
#   7 [label="{  a7 | 1 } | { 6 | 7 } | { 8 | 9 } | { 2 | 0 }"]
#   8 [label="{  a8 | 7 } | { 7 | 14 } | { 9 | 16 } | { 2 | 2 }"]
#   9 [label="{  a9 | 8 } | { 8 | 16 } | { 8 | 16 } | { 0 | 0 }"]
#   11 [label="{ a11 | 3 } | { 7 | 10 } | { 13 | 16 } | { 6 | 6 }"]
#   12 [label="{ a12 | 0 } | { 16 | 16 } | { 16 | 16 } | { 0 | 0 }"]
#   {rank=same 2 3 4}
#   {rank=same 5 6 10}
#   /*  (2 3 4) 5 6 10  7 9  8 11 12 */
#     2 -> 5
#   3 -> 10
#   4 -> 6
#   5 -> 9
